...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv("G:\My Drive\python\demo_graph\\adult.data.csv")  # replace 'your_dataset.csv' with your actual file path
    ...
    highest_earning_country_percentage = (country_stats.max() * 100).round(1)
